function createFaq() {
  ...
  faqHeader5.textContent = "CREDIT CARD CHARGE INQUIRIES";

  const faqPara5 = document.createElement("p");
  faqPara5.classList.add("faq-para");
  faqPara5.textContent =
    "For Credit Card Charge inquiries, please allow two business days for your bank to settle all pending charges.  If charges are still not correct, please email hello@louierestaurant.com and send us the last 4 digits of your card along with any extra information so we can correct any errors.";

  const faqHeader6 = document.createElement("h2");
  faqHeader6.classList.add("faq-header");
  faqHeader6.textContent = "PRESS INQUIRIES";

  const faqPara6 = document.createElement("p");
  faqPara6.classList.add("faq-para");
  faqPara6.textContent =
  ...
  faq.appendChild(faqHeader6);
  faq.appendChild(faqPara6);
